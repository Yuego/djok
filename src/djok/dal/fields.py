from dal_select2_queryset_sequence.fields import Select2GenericForeignKeyModelField as Field
from dal_select2_queryset_sequence.widgets import QuerySetSequenceSelect2
from django.urls import re_path as url
from queryset_sequence import QuerySetSequence

from .views import Select2QuerySetSequenceAutoView

__all__ = ['Select2GenericForeignKeyModelField']


class Select2GenericForeignKeyModelField(Field):
    """
